...
class Controller{
  ...
  static Future<Map> checkIfVolunteered(int activityId) async {
    ...
    var res = await CallApi().getDataWToken("/api-check-if-volunteered/$activityId", token);
    var body = await json.decode(res.body);
  ...
  static Future<List<Map>> getGroupActivities(int groupId) async {
    ...
    var res = await CallApi().getDataWToken("/api-group-activities/$groupId", storage.get('token'));
    var body = await json.decode(res.body);
  ...
  static Future<List<Map>> getGroupEvents(int groupId) async {
    ...
    var res = await CallApi().getDataWToken("/api-group-events/$groupId", storage.get('token'));
    var body = await json.decode(res.body);
  ...
  static Future<List<Map>> getGroupResources(int groupId) async {
    ...
    var res = await CallApi().getDataWToken("/api-group-resources/$groupId", storage.get('token'));
    var body = await json.decode(res.body);
  ...
  static Future<List<Map>> getGroupNews(int groupId) async {
    ...
    var res = await CallApi().getDataWToken("/api-group-news/$groupId", storage.get('token'));
    var body = await json.decode(res.body);
  ...
  static Future<List<Map>> getUserVolunteeredActivities() async {
    ...
    var res = await CallApi().getDataWToken("/api-user/get-volunteered-activities", storage.getString('token'));
    var body = await json.decode(res.body);
