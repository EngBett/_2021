                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: SingleAppTheme.buildLightTheme().dividerColor,
                      ),
                    ),
                    child: Material(
          ...
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                  color: SingleAppTheme.buildLightTheme().primaryColor),
            ),
          ),
        ),
      );
                            ...
                            decoration: BoxDecoration(
                              color: startDate != null && endDate != null
                                  ? getIsItStartAndEndDate(date) ||
                                          getIsInRange(date)
                                      ? SingleAppTheme.buildLightTheme()
                                          .primaryColor
                                          .withOpacity(0.4)
                                      : Colors.transparent
                                  : Colors.transparent,
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: getIsItStartAndEndDate(date)
                                  ? SingleAppTheme.buildLightTheme().primaryColor
                                  : Colors.transparent,
                              borderRadius:
                                  const BorderRadius.all(Radius.circular(32.0)),
                              border: Border.all(
