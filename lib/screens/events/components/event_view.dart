...
class EventView extends StatelessWidget {
  ...
  const EventView(
      {Key key, this.animationController, this.animation, this.event})
      : super(key: key);

  void moveTo(BuildContext context) {
    Navigator.pushNamed(context, EventViewScreen.routeName,arguments: event);
  }
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        fontSize: 16,
                                        letterSpacing: -0.2,
                                        color: AppTheme.darkText.withOpacity(0),
                                      ),
                                    ),
